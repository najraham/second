<aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li>
                <a class="app-menu__item @if ($title == "users") active @endif" href="{{route('show_dashboard_user_page', ['type' => 'ALL'])}}"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label"> Users</span></a>
            </li>
            <li>
